      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        ...
        <div class="flex items-start">
          <input
            ...
            type="checkbox"
            required
            class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded mt-0.5"
          />
          <label for="terms" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
            I agree to the 
            <a href="#" class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors duration-200">Terms and Conditions</a>
            and 
            <a href="#" class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors duration-200">Privacy Policy</a>
          </label>
        </div>
...
const handleRegister = async () => {
  ...
  try {
    ...
    notifications.success(`Welcome to the platform, ${response.data?.user.name}!`, {
